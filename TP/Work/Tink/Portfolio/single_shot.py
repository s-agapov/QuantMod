...
TOKEN = 't.UFRJ8SC9hafVOhFxEUY7yf1wZ1gGhwJp-WCp9o4rnEChHWns0c3jQ21eQwoOW_RurFqeZpss2scJkmMQnomJ9g'
...
class PortfolioStrategy:
    ...
    def __init__(
        ...
        self.ticker_base = tink.get_id_base(TOKEN)
    ...
    async def get_historical_data(self):
        ...
        for ticker in portfolio:
            figi = tink.ticker_to_figi(ticker, self.ticker_base)
...
if __name__ == "__main__":
    ...
    days_back = 1
    check_interval = 60  # seconds to check interval for new completed candle

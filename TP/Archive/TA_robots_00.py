...
robots = ['ma','ma_2_crossover','ma_2_crossover_ichimoku', 'ma_rsi', 'ma_rsi_01', 'rsi_ma', 'rsi__ma', 'rsi', 'macd', 'kestner_ma']
...
class ma:  
    ...
    def signals (self, data, ma_window):
        ticks = data['C'].values
...
class rsi_ma:
    ...
    def signals (self, data, rsi_window, rsi_buy, ma_window):
        ticks = data['C'].values
        rsi = talib.RSI(ticks * 100, rsi_window)
        ma  = talib.MA(ticks, ma_window)
